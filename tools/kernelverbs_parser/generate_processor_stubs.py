...
def generate_processor_stub(processor: EFPProcessor, verb_names: List[str]) -> str:
    ...
    lines = [
        ...
        f' *',
        f' * IMPORTANT: DO NOT implement verbs by hand-editing this file.',
        f' * To add implementations:',
        f' *   1. Create wrapper functions in Common/source/ (e.g., shellsysverbs.c)',
        f' *   2. Add entries to tools/kernelverbs_parser/stub_config.py',
