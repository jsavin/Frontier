...
def generate_processor_stub(processor: EFPProcessor, verb_names: List[str]) -> str:
    ...
    lines = [
        ...
        f' *',
        f' * IMPORTANT: When implementing verbs in this file, update this header to:',
        f' * - Remove "GENERATED FILE" and "DO NOT EDIT BY HAND" warnings',
        f' * - Add "DO NOT regenerate - this file contains production implementations"',
        f' * - Document implementation status (which verbs are complete/pending)',
        f' * See Issue #256 for the pattern.',
        f' */',
        f'',
        '#include "frontier.h"',
        '#include "standard.h"',
