 ...
 * now contains hand-written implementations for script compilation and execution.
 *
 ...
 * - script.setcode:    COMPLETE - Set compiled bytecode
...
enum {
    ...
    scrv_uncomment = 11,
    scrv_iscomment = 12,
    scrv_getbreakpoint = 13,
    scrv_setbreakpoint = 14,
    scrv_clearbreakpoint = 15,
    scrv_startprofile = 16,
    scrv_stopprofile = 17
};
