 ...
 * - script.compile:      COMPLETE - Compile UserTalk source to bytecode (PRODUCTION)
 * - script.error:        COMPLETE - Trigger runtime error (PRODUCTION)
 * - script.removeSource: STUBBED - Platform-specific (Mac license protection, not supported)
 * - script.run:          NOT PRODUCTION - No glue in Frontier.root
 * - script.getsource:    NOT PRODUCTION - No glue in Frontier.root
 * - script.setsource:    NOT PRODUCTION - No glue in Frontier.root
 * - script.getcode:      NOT PRODUCTION - No glue in Frontier.root
 * - script.setcode:      NOT PRODUCTION - No glue in Frontier.root
 *
 * Other verbs (uncompile, getlanguage, setlanguage, etc.): Stubbed for future implementation
 */
