...
static boolean clock_valueproc(short token, hdltreenode hparam1,
    ...
    switch(token) {
        case clov_clock_verb0:
            /* TODO: Implement clock.clock_verb0 */
            return false;
        case clov_clock_verb1:
            /* TODO: Implement clock.clock_verb1 */
            return false;
        case clov_clock_verb2:
            /* TODO: Implement clock.clock_verb2 */
            return false;
        case clov_clock_verb3:
            /* TODO: Implement clock.clock_verb3 */
            return false;
        case clov_clock_verb4:
            /* TODO: Implement clock.clock_verb4 */
            return false;
        case clov_clock_verb5:
            /* TODO: Implement clock.clock_verb5 */
            return false;
        case clov_clock_verb6:
            /* TODO: Implement clock.clock_verb6 */
            return false;
        default:
            return false;
    }
