/*
 * headless_tcp_verbs.c - Tcp processor verbs (GENERATED FILE)
 *
...
static boolean tcp_valueproc(short token, hdltreenode hparam1,
    ...
    switch(token) {
        case tcpv_addressdecode:
            /* Verb #0: tcp.addressdecode - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_addressencode:
            /* Verb #1: tcp.addressencode - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_addresstoname:
            /* Verb #2: tcp.addresstoname - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_nametoaddress:
            /* Verb #3: tcp.nametoaddress - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_myaddress:
            /* Verb #4: tcp.myaddress - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_abortstream:
            /* Verb #5: tcp.abortstream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_closestream:
            /* Verb #6: tcp.closestream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_closelisten:
            /* Verb #7: tcp.closelisten - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_openaddrstream:
            /* Verb #8: tcp.openaddrstream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_opennamestream:
            /* Verb #9: tcp.opennamestream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_readstream:
            /* Verb #10: tcp.readstream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_writestream:
            /* Verb #11: tcp.writestream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_listenstream:
            /* Verb #12: tcp.listenstream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_statusstream:
            /* Verb #13: tcp.statusstream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_getpeeraddress:
            /* Verb #14: tcp.getpeeraddress - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_getpeerport:
            /* Verb #15: tcp.getpeerport - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_writestringtostream:
            /* Verb #16: tcp.writestringtostream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_writefiletostream:
            /* Verb #17: tcp.writefiletostream - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_readstreamuntil:
            /* Verb #18: tcp.readstreamuntil - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_readstreambytes:
            /* Verb #19: tcp.readstreambytes - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_readstreamuntilclosed:
            /* Verb #20: tcp.readstreamuntilclosed - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_getstats:
            /* Verb #21: tcp.getstats - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case tcpv_countconnections:
            /* Verb #22: tcp.countconnections - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        default:
            return false;
