...
### Database Errors
All tests currently SKIP due to database loading errors when running with `Frontier.root`:
...
1. **Fix Database Issues**: Resolve `Frontier.root` external table address errors
