...
### Database Errors
All tests currently SKIP due to database loading errors when running with `Frontier.root7`:
...
1. **Fix Database Issues**: Resolve `Frontier.root7` external table address errors
