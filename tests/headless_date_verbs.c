...
static boolean date_valueproc(short token, hdltreenode hparam1,
    ...
    switch(token) {
        case datv_now:
            /* Verb #0: date.now - not yet implemented */
        ...
        case datv_set:
            ...
            return false;
        case datv_sleepfor:
            /* Verb #2: date.sleepfor - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_ticks:
            /* Verb #3: date.ticks - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_milliseconds:
            /* Verb #4: date.milliseconds - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_waitseconds:
            /* Verb #5: date.waitseconds - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_waitsixtieths:
            /* Verb #6: date.waitsixtieths - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_date:
            /* Verb #7: date.date - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_get:
            /* Verb #8: date.get - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_set:
            /* Verb #9: date.set - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_abbrevstring:
            /* Verb #10: date.abbrevstring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_dayofweek:
            /* Verb #11: date.dayofweek - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_daysinmonth:
            /* Verb #12: date.daysinmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_daystring:
            /* Verb #13: date.daystring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_firstofmonth:
            /* Verb #14: date.firstofmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_lastofmonth:
            /* Verb #15: date.lastofmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_longstring:
            /* Verb #16: date.longstring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_nextmonth:
            /* Verb #17: date.nextmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_nextweek:
            /* Verb #18: date.nextweek - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_nextyear:
            /* Verb #19: date.nextyear - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_prevmonth:
            /* Verb #20: date.prevmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_prevweek:
            /* Verb #21: date.prevweek - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_prevyear:
            /* Verb #22: date.prevyear - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_shortstring:
            /* Verb #23: date.shortstring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_tomorrow:
            /* Verb #24: date.tomorrow - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_weeksinmonth:
            /* Verb #25: date.weeksinmonth - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_yesterday:
            /* Verb #26: date.yesterday - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_getcurrenttimezone:
            /* Verb #27: date.getcurrenttimezone - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_netstandardstring:
            /* Verb #28: date.netstandardstring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        case datv_monthtostring:
            /* Verb #29: date.monthtostring - not yet implemented */
            if (bserror) copystring(BIGSTRING("\pnot implemented"), bserror);
            return false;
        default:
            return false;
