/*
 * headless_thread_verbs.c - Thread processor verbs
 *
 * Originally generated by tools/kernelverbs_parser/generate_processor_stubs.py,
 * but now contains production implementations. DO NOT regenerate without carefully
 * reviewing and preserving the hand-written verb implementations below.
 *
