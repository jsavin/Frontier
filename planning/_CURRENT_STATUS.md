...
- New plan doc: `planning/phase3/big_endian_portability_audit.md` tracks the remaining BE audit (avail list serialization, record metadata, reader parity, cross-arch regression, docs).
