...
- Notes: Track every legacy helper the portable build still needs; keep this list in sync with carbon migration inventory (archived).

Related Docs
- `planning/archive/phase3/carbon_migration/inventory.md` (Carbon migration reference)
