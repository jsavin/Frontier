...
FRONTIER_HEADLESS_SKIP_STARTUP=1 ./frontier-cli/frontier-cli --system-root databases/Frontier.root7 -e "defined(system)" > baseline.txt
FRONTIER_HEADLESS_SKIP_STARTUP=1 ./frontier-cli/frontier-cli --system-root databases/Frontier.root7 -e "sizeOf(system.verbs)" >> baseline.txt
```
...
```bash
# Compare behavior
FRONTIER_HEADLESS_SKIP_STARTUP=1 ./frontier-cli/frontier-cli --system-root databases/Frontier.root7 -e "defined(system)" > after_gui.txt
FRONTIER_HEADLESS_SKIP_STARTUP=1 ./frontier-cli/frontier-cli --system-root databases/Frontier.root7 -e "sizeOf(system.verbs)" >> after_gui.txt
