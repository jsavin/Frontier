...
- Owner: Codex
- Notes: Captures legacy layout; update when discoveries are made.
...
### 6. Testing
1. Capture fixtures under `planning/phase3/carbon_migration/data/` with sample WPText documents (plain text, styled text).
