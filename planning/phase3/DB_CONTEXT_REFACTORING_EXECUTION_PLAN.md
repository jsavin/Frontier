...
cd tests && make test-integration FRONTIER_CLI_ARGS="--system-root ../databases/Frontier.root7"
...
```bash
cd tests
python3 run_integration_tests.py integration/db_verbs/*.yaml --system-root ../databases/Frontier.root7
```
...
4. Verify with system root: `cd tests && make test-integration FRONTIER_CLI_ARGS="--system-root ../databases/Frontier.root7"`
