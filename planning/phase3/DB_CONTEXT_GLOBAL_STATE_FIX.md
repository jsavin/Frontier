...
- All db_verbs integration tests pass with `--system-root databases/Frontier-v7.root`
...
```bash
cd tests
make test-integration FRONTIER_CLI_ARGS="--system-root ../databases/Frontier-v7.root"
```
