...
Revisit this document whenever a branch scope shifts or a tracer bullet needs adjustment, and log those decisions in `planning/carbon_migration/decision_log.md`.
