...
Status
- State: In Progress
- Phase: Carbon Migration (Time/Clock)
- Last Updated: 2025-11-20
- Owner: Codex
- Notes: Blueprint for replacing Carbon date/time APIs; update as milestones complete.
...
## Migration Strategy
1. **Inventory Fields**  
   Enumerate every timestamp stored in the v7 root: table metadata (timeCreated/timeModified), script nodes, logs, pending scheduler entries, etc. Capture the list in `planning/phase3/carbon_migration/data/timestamp_fields.md`.
