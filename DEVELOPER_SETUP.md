...
- Dead code removal strategy: `planning/DEAD_CODE_ANALYSIS.md`
- Logging infrastructure design: `planning/LOGGING_INFRASTRUCTURE.md`
- Code analysis reports: `reports/` directory (generated by scripts)
