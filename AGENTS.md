...
- Treat the kernel↔UserTalk bridge doc (`planning/carbon_migration/kernel_userTalk_bridge.md`) as canonical for token/search-path behavior; consult/update it whenever you learn new details about runtime dispatch or table hydration.
