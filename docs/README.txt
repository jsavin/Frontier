...
B. Microsoft Visual Studio (legacy)
====================================

The historical Visual Studio project files (`build_VC*`) have been removed.
Windows build support will be revisited once the modern headless workflow is
fully stabilised.
